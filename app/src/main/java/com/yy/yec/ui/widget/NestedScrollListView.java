...
public class NestedScrollListView extends ListView implements NestedScrollingChild {
    ...
    public NestedScrollListView(final Context context) {
        super(context);
        initHelper();
    }

    public NestedScrollListView(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        initHelper();
    }

    public NestedScrollListView(final Context context, final AttributeSet attrs, final int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initHelper();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public NestedScrollListView(final Context context, final AttributeSet attrs, final int defStyleAttr, final int defStyleRes) {
